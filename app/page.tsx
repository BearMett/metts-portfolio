    ...
    <div className="flex flex-col gap-8 py-8 md:py-12">
      <section className="flex flex-col gap-4 md:flex-row md:gap-8">
        ...
        <div className="space-y-4">
          ...
          <h2 className="text-2xl text-muted-foreground">제가 일에 임하는 가치관은</h2>
          ...
          <h2 className="text-2xl text-muted-foreground">이런 가치관을 토대로 업무에 임할 때</h2>
          <ul className="list-disc list-inside text-lg text-muted-foreground space-y-2">
          ...
          <h2 className="text-2xl text-muted-foreground">저의 강점은</h2>
          <ul className="list-disc list-inside text-lg text-muted-foreground space-y-2">
            <li>
