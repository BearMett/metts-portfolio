...
export const portfolioData: PortfolioItem[] = [
  {
    id: 'bnz-latex-hwpx',
    date: '2024-03',
    company: '주식회사비엔제트 (BnZ)',
    title: 'LaTeX to hwpx 변환기 개발',
    shortDesc: '유사 문제 제공 서비스의 사용자 편의성을 개선하기 위한 LaTeX to hwpx 변환기 개발',
    description:
    ...
    images: [
      { src: '/portfolio/problem-to-hwpx.png', alt: 'hwpx 파일로 변환한 화면' },
      { src: '/portfolio/markdown-preview.png', alt: 'LaTex와 수식을 렌더링 한 화면' },
    ],
  },
  {
    id: 'bnz-mdtex-parser',
    date: '2024-01',
    company: '주식회사비엔제트 (BnZ)',
    title: '수학 문제 풀이 솔루션의 텍스트/수식 오류 복구 도구',
    shortDesc: 'LLM이 생성한 수학 풀이에서 수식 구분자 오류를 자동으로 수정하는 파서 개발',
    description:
      '수학 문제 풀이를 제공하는 LLM 기반 서비스에서 LaTeX 수식과 마크다운 구문 분석기를 개발했습니다. LLM이 생성한 답변에서 수식 구분자($)가 누락되거나 짝이 맞지 않는 문제가 발생했고, 이는 사용자 화면에 잘못된 내용이 렌더링 되는 심각한 UI 문제를 야기했습니다.',
    ...
    images: [
      { src: '/portfolio/correctness-latex.png', alt: '올바르게 수정된 LaTeX 구문' },
      { src: '/portfolio/borken-latex.png', alt: '사용자에게 잘못 표시되는 LaTeX 구문' },
    ],
  },
  {
    ...
    date: '2023-12',
    company: '주식회사비엔제트 (BnZ)',
    title: '학생 질문 유사 문제 검색 벡터 파이프라인 구축',
    shortDesc: '임베딩 기반 유사 문제 검색 시스템 개발로 질문-문제 연결성 강화',
    description:
  ...
  },
  {
    ...
    date: '2023-11',
    company: '주식회사비엔제트 (BnZ)',
    title: '교육 서비스 보일러플레이트 프로젝트 작성',
    shortDesc: '교육 도메인을 위한 표준화된 기술 스택과 아키텍처 구성',
    description:
  ...
  },
  {
    ...
    date: '2023-10',
    company: '주식회사비엔제트 (BnZ)',
    title: '교육 서비스 도메인 정리 및 운영 기능 구축',
    shortDesc: '서비스 안정성과 유지보수성 향상을 위한 아키텍처 재설계',
    description:
    ...
    category: ['backend', 'devops', 'refactoring'],
    tasks: [
  ...
  },
  {
    id: 'maxst-tlona',
    date: '2023-08',
    company: '주식회사맥스트 (Maxst)',
    title: "메타버스 플랫폼 '틀로나' 웹서버 개발",
    shortDesc: '현실 기반 월드와 소셜 기능을 제공하는 메타버스 백엔드 구현',
    description:
      '"틀로나"는 현실 세계를 기반으로 한 메타버스 플랫폼으로, 사용자가 가상 공간과 토지를 소유하고 다른 사용자들과 소통 할 수 있습니다. 플랫폼 내에서 NFT 토지 거래와 공간 개발을 통해 콘텐츠 제공자로 활동할 수 있습니다. 저는 메타버스 경험의 핵심 요소인 회원 관리, 가상 아이템 상점, 토지 소유권 관리 등의 기반 시스템을 개발하고 이를 API로 제공했습니다.',
  ...
  },
  {
    ...
    date: '2023-05',
    company: '주식회사맥스트 (Maxst)',
    title: '틀로나 독립 서버 환경 실행 자동화',
    shortDesc: '컨테이너 기반 로컬 개발 및 테스트 환경 구축',
    description:
  ...
  },
  {
    ...
    date: '2022-09',
    company: '(주) 웨어밸리',
    title: '경쟁사 제품의 DB 접근제어 정책 이관',
    shortDesc: '대규모 보안 정책의 자동화된 분석 및 이관 시스템 구축',
    description:
  ...
  },
  {
    ...
    date: '2022-03',
    company: '(주) 웨어밸리',
    title: '샤크라맥스 V4의 보안적합성검증(CC) 인증',
    shortDesc: '국가 보안 인증을 위한 시스템 개발 및 검증',
    description:
  ...
  },
  {
    ...
    date: '2021-06',
    company: '(주) 웨어밸리',
    title: '고객사 인사정보-사용자 정보 연동 솔루션',
    shortDesc: '대기업 맞춤형 인사 데이터 통합 및 자동화 시스템',
    description:
...
export const portfolioCategories = [
  { id: 'all', label: '전체 보기', icon: 'Filter' },
  { id: 'backend', label: '백엔드 개발', icon: 'Server' },
  { id: 'database', label: '데이터베이스', icon: 'Database' },
  { id: 'devops', label: 'DevOps/인프라', icon: 'Cloud' },
  { id: 'security', label: '보안', icon: 'Shield' },
  { id: 'parser', label: '파서/분석', icon: 'Code' },
  { id: 'ai', label: 'AI/머신러닝', icon: 'Brain' },
  { id: 'refactoring', label: '리팩토링', icon: 'RefreshCw' },
  { id: 'integration', label: '시스템 연동', icon: 'Link' },
  { id: 'frontend', label: '프론트엔드', icon: 'Layout' },
  { id: 'search', label: '검색 엔진', icon: 'Search' },
];
